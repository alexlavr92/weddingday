    ...
    return (
        <section className={`${styles.hero} h-screen md:min-h-[975px] relative flex flex-col`}>
            ...
            <Container className="h-full flex-1 flex flex-col items-center">
                ...
                <p className="mt-auto text-center mb-[25px] text-[1rem] md:text-[1.5rem] leading-[1.1]">
                    Мы будем счастливы разделить<br></br> этот день вместе с вами
                </p>
                {/* Локация */}
                <a href='https://yandex.com/maps/-/CPfkqX0b' target="_blank" className="mb-[4rem] md:mb-[5rem] md:w-full xl:w-auto gradient-default z-[1] text-main-blue btn flex gap-[0px] md:gap-[10px] items-start md:items-center justify-center btnShine leading-[1.2]">
                    <img src={MapPin} alt="" className="hidden md:block w-[20px] md:w-[33px]" />
                    <span className="max-w-[86%] md:max-w-none">Тортуга холл (Воронежская улица, 35/1, Ленинский район, Уфа)</span>
                </a>
            </Container>
